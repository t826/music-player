...
<div class="left-bar" style="left: {openList ? '0px' : ''};">
	...
	<div class="left-1 ">
		...
		>
			<i class="iconfont" style="font-size:28px;margin-right: 5px;"> &#xe624; </i>
			<span>影音娱乐 </span>
			<i class="iconfont jiantou" style="{openYingyinList ? 'transform:rotate(90deg)' : ''};">
				&#xe64a;
			</i>
		</a>
		<ul class="yingyin-list" style={openYingyinList ? 'height:85px' : ''}>
...
<style>
	...
	.left-bar {
		font-family: Helvetica, 'Hiragino Sans GBHiragino Sans GB', 'Microsoft Yahei', '微软雅黑', Arial,
			sans-serif;
		overflow-y: auto;
		overflow-x: hidden;
		/* 固定左侧栏不随鼠标滚动 */
